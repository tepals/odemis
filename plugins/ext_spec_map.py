...
#   The scan is expected to be raster-line type (eg, not zigzag)
...
#   this plugin, and press the button to be "READY FOR ACQUSITION".
...
class ExternalAcquisition:
    ...
    def _update_exp_dur(self, _=None):
        """
        Shows how long the acquisition takes to acquire
        """
    ...
    def _acquire_spec(self, dlg, future) -> Tuple[Optional[model.DataArray], bool]:
        ...
        # frame_dur = self.spectrometer.framePeriod.value
        ...
        try:
            ...
            while len(specs) < num_acqs:
                ...
                # left_time = (num_acqs - len(specs)) * frame_dur + 0.1
